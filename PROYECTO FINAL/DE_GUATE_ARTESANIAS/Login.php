...
if (!isset($_SESSION['user'])) {
    ...
    <html>
        <head>
            <meta charset="UTF-8">
            <title>Admin De Guate Artesanias | Log in</title>
            ...
            <!-- iCheck -->
            <link href="./Administrador/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
        ...
        <body class="login-page">
            <div class="login-box">
                <div class="login-logo">
                    <a href="index.php"><b>Admin</b>De Guate Artesanias</a>
                </div><!-- /.login-logo -->
                <div class="login-box-body">
                    <p class="login-box-msg">Login Administrador</p>
                    <form action="./INCLUDES/Usuarios.php?act=3" method="post">
            ...
            <!-- iCheck -->
            <script src="./Administrador/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
            <script>
                $(function () {
                    $('input').iCheck({
