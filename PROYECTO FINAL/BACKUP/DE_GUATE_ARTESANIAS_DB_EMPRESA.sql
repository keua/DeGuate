...
INSERT INTO `EMPRESA` (`EMPRESA`, `NOMBRE`, `SLOGAN`, `MISION`, `VISION`, `DESCRIPCION`, `TELEFONO`, `DIRECCION`, `CORREO`, `NOVEDADES`) VALUES (1,'ARTESANIAS','DE GUATEMALA','MISION','VISION','DESCRIPCION',8989898,'GUATEMALA','CORREO@CORREO.COM','NOVEDADES');
